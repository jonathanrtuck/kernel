...
- [Claims](design/claims.toml) · Single source of truth for design decisions.
  Each claim has a statement, status, confidence, scope, and rationale.
...
- [Landscape](design/landscape.md) · Survey of how 18+ real kernels and academic
  systems resolved each major design decision. Organized by decision point.
  Lists known approaches, tradeoffs, and novelty opportunities.
