...
//
// When spec.md or .brain/state/question.md is modified, this script spawns
...
process.stdin.on("end", () => {
  ...
  try {
    ...
    const lockPath = path.join(cwd, ".brain", ".lock");
    ...
    const runner = path.join(cwd, ".brain", "run-agents.js");
    ...
    process.stdout.write(
      JSON.stringify({
        additionalContext: `[brain] Agents triggered by change to ${relative}. Results will appear in .brain/state/ when complete.`,
      }),
    );
  } catch {
