//! Cross-core Field contention.
//!
//! N senders on (ideally) different cores all sending to the same Field.
//! Consumer receives. Measures throughput degradation as sender count
//! increases. Stresses the Arena<Field> lock (D53).
...
const TAG_N2: u64 = 0x450;
const TAG_N4: u64 = 0x455;
